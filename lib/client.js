        ...
        open ? React.createElement('div', { className: 'dp-popover' },
          ...
          info.enabled && recentRows.length > 0 ? [
            ...
            ...recentRows.map((e) => {
              ...
              return React.createElement('div', { key: e.seq, className: 'dp-popover-row' },
                React.createElement('span', { className: 'dp-dot ' + dec[1] }),
                React.createElement('span', null, e.tool),
                React.createElement('span', { style: { opacity: .6, overflow: 'hidden', textOverflow: 'ellipsis' } }, e.arg),
                React.createElement('b', { style: { marginLeft: 'auto', flex: 'none' } }, t(dec[0])))
            }),
          ] : null,
