...
`
    ...
    function PermissionsSettingsPage(props) {
      ...
      const scopeBtns = [React.createElement('button', {
        key: 'global',
        className: scope === 'global' ? 'dp-mode-btn dp-on' : 'dp-mode-btn',
      ...
      for (const w of workspaceItems) {
        ...
        scopeBtns.push(React.createElement('button', {
          key: id,
          className: scope === 'ws:' + id ? 'dp-mode-btn dp-on' : 'dp-mode-btn',
          onClick: () => setScope('ws:' + id),
        }, w.title))
      }
      const scopeBar = React.createElement('div', { className: 'dp-bar' },
        React.createElement('div', { className: 'dp-mode-seg' }, scopeBtns),
